...
@section('content')
<div class="p-5 text-center" style="background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('{{ asset('img/gambar1.jpg') }}'); background-size: cover; backgroung-positio: center; height: 600px; display: flex; align-items: center; justify-content: center; color: white;">
    <div class="container">
        ...
        <p class="mx-auto mb-4 text-white-50" style="line-height: 28px; font-size: 18px; max-width: 700px;">
        ...
        <div class="mb-4 d-flex align-items-center justify-content-center gap-2 text-warning" style="font-size: 16px;">
    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-md-4">
            <div class="card h-100 border-0 shadow-sm rounded-3 overflow-hidden">
                ...
                <div class="card-body p-4 text-center">
                    <span class="badge bg-success-subtle text-succes mb-2 px-3 py-1 text-uppercase" style="font-size: 11px; font-weight: 600:">Cemilan</span>
